                                ...
                                <a href="#" class="nav-link pe-1 ps-0 leading-none" data-bs-toggle="dropdown">
                                    <span>
                                        @if(Auth::check() && Auth::user()->image)
                                            <img src="{{ asset('assets/images/users/' . Auth::user()->image) }}" alt="img" class="avatar avatar-md bradius">
                                        @else
                                            <img src="{{ asset('assets/images/default-avatar.jpg') }}" alt="default img" class="avatar avatar-md bradius"> <!-- Default image if no user image is set -->
                                        @endif
                                    </span>
