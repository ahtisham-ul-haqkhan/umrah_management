                        ...
                        <div class="form-group ">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 mb-3">
                                    <label class="form-label" for="basic-icon-default-fullname">Name <span class="text-danger fw-bold"> *</span>    </label>
                                ...
                                <div class="col-sm-12 col-md-6 mb-3">
                                    <label class="form-label" for="basic-icon-default-fullname"> Code <span class="text-danger fw-bold"> *</span>    </label>
                                    <div class="input-group input-group-merge">
                                ...
                                <div class="col-sm-12 col-md-6 mb-3">
                                    <label class="form-label" for="basic-icon-default-fullname">Logo<span class="text-danger fw-bold"> *</span></label>
                                    <div class="input-group input-group-merge">
                                ...
                                <div class="col-sm-12 col-md-6 mb-3">
                                    <label class="form-label" for="basic-icon-default-fullname">Stamp<span class="text-danger fw-bold"> *</span></label>
                                    <div class="input-group input-group-merge">
        ...
        <div class="row mt-2" id="address_${addressIndex}">
            ...
            <div class="col-sm-6 col-md-3 mb-3">
             ...
             <div class="col-sm-12 col-md-1 mt-5">
                    <button class="btn btn-outline-danger float-end" type="button" onclick="removeField('address_${addressIndex}')">
    ...
    const newContact = `
        <div class="row mt-2" id="contact_${contactIndex}">
            ...
            <div class="col-sm-6 col-md-3 mb-3">
              ...
              <div class="col-sm-12 col-md-1 mt-5">
                    <button class="btn btn-outline-danger float-end" type="button"  onclick="removeField('contact_${contactIndex}')">
                    <i class="feather feather-trash-2 text-danger"></i>
                </button>
            </div>
            <hr>
    ...
    const newEmail = `
        <div class="row mt-2" id="email_${emailIndex}">
            ...
            <div class="col-sm-6 col-md-3 mb-3">
                <label class="form-label">Preferred?</label>
                <div class="input-group input-group-merge">
                    <select class="form-select" name="emailprefered[]">
                        <option value="true" selected="">Yes</option>
                        <option value="false">No</option>
                    </select>
                </div>
               ...
               <div class="col-sm-12 col-md-1 mt-5">
                    <button class="btn btn-outline-danger float-end" type="button"  onclick="removeField('email_${emailIndex}')">
                   <i class="feather feather-trash-2 text-danger"></i>
                </button>
            </div>
            <hr>
    ...
    const newLicense = `
        <div class="row mt-2" id="license_${licenseIndex}">
            ...
            <div class="col-sm-12 col-md-7 mb-3">
             ...
             <div class="col-sm-12 col-md-1 mt-5">
                    <button class="btn btn-outline-danger float-end" type="button" onclick="removeField('license_${licenseIndex}')">
                    <i class="feather feather-trash-2 text-danger"></i>
                </button>
            </div>
        </div>
